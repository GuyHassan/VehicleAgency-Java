...
public class JeepPanel extends JPanel implements VehiclePanelsInterface{
	
	private static JLabel pic;
	private static ImageIcon[] img = {new ImageIcon("img\\jeep1.jpg"),new ImageIcon("img\\jeep2.jpg"),new ImageIcon("img\\jeep3.jpg"),new ImageIcon()};
	...
	{
		arrangeLabel_Text();
		comboBox.setBounds(0, 210 , 150, 20);
	...
	public boolean addVehicleToList()
	{
			if(pic.getIcon() != null)
			{
				...
				interfaceVehicle jeep = factory.getNewVehicle("Jeep", text ,null,colorCH);
				if(!jeep.equals(null)) {
					MainVehicleAgency.arrV.add(jeep);
